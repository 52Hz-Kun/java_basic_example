...
public class CustomerView {
    ...
    public CustomerView(){
        Customer customer = new Customer("张三", '男', 20, "15162120777", "1014770532@qq.com");
        customerList.addCustomer(customer);
    }
    /**
     * 显示主菜单，响应用户输入，根据用户操作分别调用其他相应的
     * 成员方法（如addNewCustomer），以完成客户信息处理。
     */
